...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      demoLink: 'https://drive.google.com/file/d/1Uyheuf1ub-tA4mn_LYFK9wtIm7v-pLDK/view?usp=sharing',
      githubLink: 'https://github.com/piyushtiwari2711',
    ...
    <section id="projects" className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            <motion.button
              className="px-8 py-3 border-2 border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white rounded-full transition-all duration-300"
